...
<input type="button" onclick="returnHome2()" style="width:30%; height:40px;position:absolute;top:270px;left:370px;font-size:20px;border:2px solid black;font-family:lucida calligraphy;" value="Return to Home">
<br>
